...
function optimize!(model::JuMP.Model, method::XQWT2019_mod.Method)::Nothing
    ...
    function lazyCons(cb_data)
        isLazy = true
        _callback_function1(cb_data, isLazy, model, method)
    end
...
function _callback_function1(cb_data, isLazy, model, method)
